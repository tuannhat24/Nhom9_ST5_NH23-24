            ...
            <div class="footer__bottom">
                <div class="grid">
                    <div class="footer__checked">
                        ...
                        <p class="footer__checked-text"> Công ty TNHH FinnVu</p>
                    </div>
                    <div class="footer__info">
                        <p class="footer__info-text">Địa chỉ số 31-33,đường 19,phường Thạnh Mỹ Lợi,thành phố Thủ Đức,thành phố Hồ Chí Minh</p>
                        <p class="footer__info-text">© 2023 - Bản quyền thuộc về Công ty TNHH FinnVu</p>
                    </div>
                </div>
            </div>
        </footer>