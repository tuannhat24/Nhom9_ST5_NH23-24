    ...
    <div class="grid">
        <div class="grid__row">
            ...
            <div class="grid__column-2-4">
                ...
                <ul class="footer-list">
                    <li class="footer-item">
                        <a href="https://www.facebook.com/finn.264/" class="footer-item__link">
                            <i class="footer-item__icon fa-brands fa-facebook"></i>
                            Facebook
                        </a>
                        <a href="https://www.instagram.com/im.vulinh__/" class="footer-item__link">
    ...
    <div class="footer__bottom">
        <div class="grid">
            ...
            <div class="footer__info">
                <p class="footer__info-text">Địa chỉ số 53,đường Võ Văn Ngân,phường Linh Chiểu,thành phố Thủ Đức,thành phố Hồ Chí Minh</p>
                <p class="footer__info-text">© 2023 - Bản quyền thuộc về N9</p>
            </div>
        </div>
    </div>
</footer>