...
<body>
    ...
    <script>
       var url = "{{ route('admin.statistics') }}";
    console.log(url);
        ...
        $(document).ready(function() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#mostFavoritedProduct').text(data.mostFavoritedProduct ? data.mostFavoritedProduct.name : 'N/A');
                    $('#categoryWithMostProducts').text(data.categoryWithMostProducts ? data.categoryWithMostProducts.name : 'N/A');
                },
                error: function() {
